...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (session) {
      toast.success(`Already logged in as ${session.user?.name || "User"} 👋`);
      router.push("/");
    }
  }, [session, router]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[rgb(244,242,238)] p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Vibely</h1>
